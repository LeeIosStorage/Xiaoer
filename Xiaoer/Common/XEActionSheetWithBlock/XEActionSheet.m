...
@interface XEActionSheet()<UIActionSheetDelegate>

@property (nonatomic, strong) XEActionSheetBlcok clickBlock;
@end

@implementation XEActionSheet
...
-(id)initWithTitle:(NSString *)title actionBlock:(XEActionSheetBlcok) actionBlock cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...
{
