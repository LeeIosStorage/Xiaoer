...
#define TAG_USER_IDENTITY  0
#define TAG_BOBY_DATE      1
#define TAG_USER_PHONE     2
#define TAG_USER_REGION    3
#define TAG_USER_ADDRESS   4
...
-(NSDictionary *)tableDataModule{
    ...
    NSString *intro = _oldUserInfo.title;
    ...
    NSDictionary *dict10 = @{@"titleLabel": @"我的身份",
                             @"intro": intro!=nil?intro:@"",
                             };
    
    intro =_babyAgeOfMoon;
    NSDictionary *dict11 = @{@"titleLabel": @"宝宝月龄",
                             @"intro": intro!=nil?intro:@"",
                             };
    
    intro = _oldUserInfo.phone;
    NSDictionary *dict12 = @{@"titleLabel": @"常用电话",
                             @"intro": intro!=nil?intro:@"",
                             };
    
    intro = _oldUserInfo.regionName;
    NSDictionary *dict13 = @{@"titleLabel": @"所在区域",
                             @"intro": intro!=nil?intro:@"",
                             };
    intro = _oldUserInfo.address;
    NSDictionary *dict14 = @{@"titleLabel": @"详细街道",
                             @"intro": intro!=nil?intro:@"",
                             };
    
    [sectionDict0 setObject:dict10 forKey:[NSString stringWithFormat:@"r%ld",sectionDict0.count]];
